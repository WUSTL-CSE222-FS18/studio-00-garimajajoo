...
The list is only numbered with 1 and some of the words are highlighted in blue.
...
Feature | Explanation
------- | ------------
Health | GlowCaps helps people regularly take prescription meds by sending them messages
Safety | Wemo Outlet helps make sure the oven is off by turning it off remotely being able to turn off from anywhere in the world
Maintenance | ConnectSense sends notifications if any unexpected motion or pipes burst happens while you're away.
Sustainability | BigBelly uses real time data to notify municipalities when trash bins need to be emptied
